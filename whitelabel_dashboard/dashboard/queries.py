"""
SQL Queries - EDIT THIS FILE for new dashboards

All queries are kept here to separate data layer from visualization.
Queries are written for Snowflake SQL syntax.

CHANGE THESE when creating a new dashboard:
- Update MAIN_TABLE and RECEIVABLES_TABLE to point to your data sources
- Modify SQL queries as needed for your specific data schema
"""

# =============================================================================
# Table References - CHANGE THESE FOR NEW DASHBOARDS
# =============================================================================
...
# =============================================================================
# Query Functions - MODIFY AS NEEDED FOR YOUR DATA SCHEMA
# =============================================================================
